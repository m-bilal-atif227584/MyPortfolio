    ...
    <section className='hero relative w-full h-screen mx-auto'>
      <div className={`herocont ${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          ...
          <p className={`${styles.heroSubText} text-[#f3f3f3] mt-2`}>I develop seamless, visually stunning, user-friendly <br className='sm:block hidden' /> interfaces and high-performance web applications</p>
        </div>
      </div>
